...
// Update the Yup validation function
...
class Profile extends Component {
  ...
  // function that store the user id returned from the above function in the component state.
  componentDidMount() {
    let { id } = this.parseJwt();
    this.getData(id);
  }

  //  to show its preview to the user
  ...
  // updating the src attribute with the avatar attribute of the user object.
  getData = async (id) => {
    await axios
